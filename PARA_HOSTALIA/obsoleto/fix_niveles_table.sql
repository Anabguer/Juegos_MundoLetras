-- Crear tabla mundoletras_niveles con la estructura correcta
...
CREATE TABLE mundoletras_niveles (
    ...
    CONSTRAINT mundoletras_niveles_fk1 FOREIGN KEY (usuario_aplicacion_key) REFERENCES usuarios_aplicaciones (usuario_aplicacion_key) ON DELETE CASCADE,
    CONSTRAINT mundoletras_niveles_fk2 FOREIGN KEY (tema_id) REFERENCES mundoletras_temas (tema_id) ON DELETE CASCADE
